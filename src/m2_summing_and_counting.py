...
def run_test_sum_more_cosines():
    ...
    print()
    print('--------------------------------------------------')
    print('Finished testing the   sum_more_cosines   function:')
    print('--------------------------------------------------')
...
def run_test_count_sines_from():
    ...
    print()
    print('--------------------------------------------------')
    print('Finished testing the   count_sines_from   function:')
    print('--------------------------------------------------')
    # ------------------------------------------------------------------
    # TO DO: 4 (continued).
...
def run_test_count_sines_vs_cosines():
    ...
    print()
    print('--------------------------------------------------')
    print('Finished testing the   count_sines_vs_cosines  function:')
    print('--------------------------------------------------')
    # ------------------------------------------------------------------
    # TO DO: 6 (continued).
    # Below this comment, add 5 more test cases of your own choosing.
